...
class OpusEncoderUtils:
    ...
    def __init__(self, sample_rate: int, channels: int, frame_size_ms: int):
        ...
        # 比特率和复杂度设置
        # 64000：24kHz 全頻語音的乾淨門檻。實測 24kbit→SNR 7.4dB(有雜訊)、
        # 64kbit→20.1dB(乾淨)、96kbit→27.8dB。原 24kbit 把語音壓太兇是雜訊主因。
        # 64kbit 對 WiFi(8KB/s)與 ESP32-S3 解碼都輕鬆。要更乾淨可改 96000。
        self.bitrate = 64000  # bps
